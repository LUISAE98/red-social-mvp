      ...
      >
        ...
        {consejoCalc ? (
          <div style={subtleStyle}>
            Por un consejo de{" "}
            {formatMoney(consejoCalc.gross, draft.consejo.currency)}, tú cobras{" "}
            {formatMoney(consejoCalc.net, draft.consejo.currency)}.
          </div>
        ) : null}
  ...
  return (
    <>
      <div style={panelStyle}>
        ...
        >
          <div style={{ display: "grid", gap: 2, minWidth: 0 }}>
            <span style={titleStyle}>{consejoEmoji} Consejos</span>
          </div>
      ...
      <OverlayModalComponent
        ...
        title={`${consejoEmoji} Configurar consejos`}
        loading={saving}
