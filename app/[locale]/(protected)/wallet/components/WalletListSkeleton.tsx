...
//
// La forma resultó ser la misma que la de experiencias, sesiones y compras, así
// que la implementación vive en el primitivo compartido y esto quedó como el
// nombre que ya usaban las pantallas del wallet.
export { CardsSkeleton as WalletCardsSkeleton };
