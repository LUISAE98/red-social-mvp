...
// Tipos, helpers y sub-componente Avatar de PostComposerMobileOverlay.
...
export type PostComposerMobileOverlayProps = {
  open: boolean;
  onClose: () => void;
...
export type PublishVisualState = "idle" | "loading" | "success";
