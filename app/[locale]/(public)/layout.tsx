...
export default function PublicLayout({
  ...
  return (
    <>
      ...
      <style>{`.vb-pub-lang-wrap{display:flex;gap:4px;position:fixed;top:14px;inset-inline-end:16px;z-index:200}@media(max-width:900px){.vb-pub-lang-wrap{display:none}}`}</style>
