...
| ✅ **Cuándo se aplica la retención al saldo** | **REVERTIDO Y RESUELTO (2026-09-03): se retiene AL VENDER.** La decisión del 2026-08-26 era retener al retirar, para que el creador viera su 75% íntegro. Se revirtió con dos argumentos nuevos: el dinero ya está **a su disposición** desde que se le abona el saldo, así que retener semanas después es retener tarde —y una retención extemporánea es **pasivo de Vibra**—; y el complemento del SAT pide la **fecha del servicio** en cada nodo, con periodicidad solo semanal o mensual, así que una constancia armada desde los retiros no se puede expresar. Se aplica **uniforme a todos**, no partido por país: la frontera fiscal es si hay retención mexicana, no la nacionalidad del creador. La preocupación original —que el saldo no baje sin explicación— se resuelve explicándolo en la wallet. Ver `pendientesimpuestos.md` §A5. |
...
| ✅ **Clave de retención** | **RESUELTA (2026-09-02) con fuente oficial.** Es la **`26`**, «Servicios de Plataformas Tecnológicas», y va con el complemento obligatoriamente — la regla del SAT dice que con otra clave el complemento no debe existir. El tipo de servicio de Vibra es **`06` «Otro tipo de servicios»**, un cajón general del catálogo que la duda anterior había pasado por alto. ⚠️ El complemento exige un nodo **por cada operación**, no solo totales, y su periodicidad solo admite semanal o mensual. Ver `pendientesimpuestos.md` §A4. |
