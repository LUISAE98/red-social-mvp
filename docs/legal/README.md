...
> **⏸️ Bloque 3 (#8, #9) EN ESPERA (decisión 2026-07-28):** no se redactan hasta **elegir e integrar la
> procesadora** (Pagsmile o EBANX — decisión **D‑01** del [doc fiscal](./fiscal-iva-isr-plataforma.md)).
> De la procesadora dependen: si recauda/remite el impuesto o solo procesa, monedas y países habilitados,
> y la mecánica de payouts/retiros. Se redactan cuando la procesadora esté elegida e integrada.
