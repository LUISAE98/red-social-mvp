# Stripe — Referencia técnica de plataforma

> ⚠️ **DOCUMENTO SUPERADO EN LO ESENCIAL. NO es fuente de verdad.**
>
> Se conserva porque el detalle de cómo funcionan los productos de Stripe sigue siendo útil.
> Pero las decisiones de negocio que aparecen abajo son de julio de 2026 y **ya no rigen**:
> la entidad cambió a Vibra On, LLC, la denominación es USD, el modelo pasó de vendedor
> directo a **intermediación**, y el mínimo de retiro es otro.
>
> Para lo vigente, ver `docs/stripe-integracion.md`.
...
Decisiones de julio de 2026 — ⚠️ **TODAS SUPERADAS**, se conservan como historial:
